...
function concat(arr1, arr2) {
    ...
    forEach(arr1, addItem);
    forEach(arr2, addItem);
...
console.log('concat');
console.log( concat([1, 2], [10, 12]) === [1, 2, 10, 12] );
console.log( concat([1, 2, 3, 4, 5], [10, 12, 13, 15]) === [1, 2, 3, 4, 5, 10, 12, 13, 15] );
console.log( concat([1, 2], [3, 4], [10, 12]) === [1, 2, 3, 4, 10, 12] );
